...
// Chapter 7 - Lab 4-7
{
    ...
    begin
        ...
        with SeminarRegHeader do begin
            ...
            CopyCommentLines( SeminarCommentLine."Table Name"::"Posted Seminar Registration", 
                            SeminarCommentLine."Table Name"::"Posted Seminar Registration", "No.",
            ...
            if SeminarRegLine.FindSet then begin 
                repeat 
                    ...
                    PstdSeminarRegLine.Init; PstdSeminarRegLine.TransferFields(SeminarRegLine); 
                ...
                until SeminarRegLine.Next = 0; end;
